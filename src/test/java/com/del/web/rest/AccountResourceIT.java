package com.del.web.rest;

import com.del.DelApp;
import com.del.config.Constants;
import com.del.domain.User;
import com.del.repository.AuthorityRepository;
import com.del.repository.UserRepository;
import com.del.security.AuthoritiesConstants;
import com.del.service.UserService;
import com.del.service.dto.PasswordChangeDTO;
import com.del.service.dto.UserDTO;
import com.del.web.rest.vm.KeyAndPasswordVM;
import com.del.web.rest.vm.ManagedUserVM;
...
import static com.del.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = DelApp.class)
